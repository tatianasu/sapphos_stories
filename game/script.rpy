...
label scene_1:
    ...
    Bard "Сказки существовали столько, сколько я себя помню."
    Bard "А помню я себя столько, сколько сколько существует мир."
    Bard "Пожалуй, у меня есть время рассказать вам кое-какую сказку."
    Bard "Сказку, которая озарит ваше утро и омрачит ваш вечер."
    Bard "Ведь за каждой красивой сказкой скрывается трагедия."

    Bard "Рано или поздно любая принцесса понимает, что ей суждено стать королевой и вести за собой государство."
    Bard "Но что покажет, что она готова взять на себя бремя власти?"
    Bard "Обряд, переживший века."
    Bard "Существующий вне времени и понимания."
    Bard "Преподнесенный щедрой рукой богов или жаждой ко власти людей?"    
    Bard "Неважно. Он направлял человечество рукой избранной королевы."
    Bard "Он - её личное испытание."

    scene bg_walls_hands
    Bard "Вместо медовой сладости яблоко принесло Белоснежке тень подозрений." 
    Bard "И больше она не увидела света."
    ...
    scene bg_walls_hands
    Bard "Вместо родных стен замка Аврора получила тюрьму."
    Bard "И больше ни одна душа не узнала, что такое тепло дома."
    ...
    scene bg_walls_hands
    Bard "Чего им не хватило? Решительности, смелости, хитрости?"
    Bard "И мы не ответим на этот вопрос."
    Bard "Но след на их жизни это оставило навсегда."
    Bard "Обряд - карающее поощрение."
    Bard "Только в осколках старого мира можно увидеть его в истинном свете."
    Bard "Успешно пройденный, он означал, что принцесса готова к восхождению на трон."
    ...
    "Слушайте мою сказку и внимайте моим словам"
    stop music fadeout 3.0
    
    play sound "audio/скрип_дверей.ogg"
    nvl clear
    "Дубовые двери распахнулись, впуская её в тронный зал."
    nvl clear
    "В безмолвии ее шаги гремели, отдаваясь от стен."
    nvl clear
    "Солнце еще не озарило горизонта, и мягкий полумрак затенял лицо короля, сидящего на троне."
    nvl clear
...
label scene_2:
    ...
    King "Леди [main_charecter_name],ты же понимаешь, что здесь делаешь в такое время?"
    hide char_king_neutral

    show char_lyra_neutral_eu
    GG_name "Обряд для принцессы?"
    hide char_lyra_neutral_eu

    "Король усмехнулся - сухо, без радости." 
    nvl clear
    "Поднял на нее уставшие, выцветшие глаза."
    nvl clear
    "Глаза старика."
    nvl clear
    ...
    show char_lyra_neutral_eu
    GG_name "{i}Я явно ему не нравлюсь{/i}"
    hide char_lyra_neutral_eu

    "В истории есть два пути героини - Долг и Честь. По пути Долга героиня будет верна короне и традициям Обряда во что бы то ни стало. По пути Чести героиня руководствуется своим сердцем. Старайтесь придерживаться одного Пути, но помните, что у каждого выбора - свои последствия."
    nvl clear

    show char_lyra_neutral_eu
    menu:   
        "Согласиться":
            GG_name  "Я постараюсь не разочаровать Вас. (+ Долг)"
            $ duty += 1
            jump scene2_dute
...
label scene2_dute:
    ...
    King "Могу поспорить, что твоя мать говорила то же самое, леди [main_charecter_name]."
...
label scene2_silence:
    ...
    show char_king_neutral
    King "Верно, стыд полностью овладел тобой из-за предательства Ингрид?"
    King "Покойной королеве было бы так же стыдно признать ошибку."
...
label scene_3:
    ...
    menu:
        "Возразить (+ Честь)":
            GG_name "Ваше Высочество, моя мать пожертвовала жизнью!"
            jump scene_3_add1
...
label scene_4:
    ...
    King "Добрый десяток лет тренеровок пошел насмарку из-за прихоти принцессы."
    
    King "Это не твоя судьба, она была уготована другой..."

    "В порыве злости король ударил кулаком по подлокотнику."
    nvl clear
    
    King "Ты не прошла подготовку! Глупая девчонка не достойна стать советницей королевы!"

    "Обессилев, король закрыл глаза."
    nvl clear

    King "Мне будет не хватать Сигрид на посту, если ты заменишь её."

    hide char_king_neutral
    show char_lyra_anger_eu
    menu:
        "Отказаться от возможности (+ Честь)":
            GG_name "Я не притендую на место наставницы. (+Честь)"
            $ honor += 1
            jump scene4_honor

        "Следовать правилам (+ Долг)":
            GG_name "После обряда рыцарь обязан принять на себя это бремя. Встать во главу королевской армии. (+Долг)"
            $ duty += 1
            jump scene4_duty
...
label scene4_honor:
    ...
    King "После обряда рыцарь обязан принять на себя бремя руководство королевской армией."
...
label scene4_duty:
    ...
    King  "Радует, что хотя бы законы ты знаешь."
    King "Не забывай, что предательство карается смертью. По этому же закону."
...
label scene_5:
    ...
    King "Надеюсь, ты не пойдешь по стопам матери. А теперь - свободна."
...
label scene_6:
    ...
    "В смешанных чувствах [main_charecter_name], поклонилась и покинула тронный зал." 
    nvl clear
    #Звук - скрип двери
    "Выйдя во внутренний двор, она остановилась, чтобы перевести дух. И тут же встретилась взглядом с наставницей."
    nvl clear
    ...
    show char_lyra_sadness_eu
    GG_name "Король говорил о моей матери."    
    GG_name "Снова называл её предательницей."
    GG_name "Сигрид, почему ты всегда юлишь, когда я спрашиваю о ней?"
    hide char_lyra_sadness_eu

    show char_sigrid_neutral
    Sigrid "Ты уже знаешь, все, что должна." 
    Sigrid "А перемывать кости павшим воинам ниже моего достоинства."
    hide char_sigrid_neutral

    show char_lyra_anger_eu
    GG_name "Ты всегда говорила мне, что она была доблестной воительницей!" 
    GG_name "Я не верю, что она могла предать корону!"
    hide char_lyra_anger_eu

    show char_sigrid_smile
    Sigrid "Сосредоточься на настоящем, а не на прошлом."
    Sigrid "Кстати, держи."
...
label faile_scene:
    scene bg_castle_courtyard
    "[main_charecter_name] не успела. Глухой стук послышался у её ног."
    nvl clear
...
label scene_8:
    ...
    show char_lyra_neutral_eu
    GG_name "Откуда он у тебя? Магия запрещена."
    hide char_lyra_neutral_eu
    ...
    'В истории есть два стата, влияющих на действия и характер героини - Клинок и Щит. По статам Клинка героиня будет остра на язык и скоропалительна в решениях. По статам Щита героиня будет более вдумчива и последовательна. Старайтесь придерживаться одного стата, но помните, что у каждого выбора будут последствия.'
    nvl clear
...
label scene8_sword:
    ...
    GG_name "Ты делаешь мне одолжение под видом помощи?" 
    GG_name "Боишься, что я не справлюсь?"
...
label scene_9:
    ...
    Sigrid "..."
    Sigrid "И всё же позволь дать тебе ещё кое-что."
    ...
    show char_sigrid_neutral
    Sigrid "А ты хотела вслепую искать?"
    hide char_sigrid_neutral

    show char_lyra_anger_eu
    GG_name "Я об этом просто не подумала."
    hide  char_lyra_anger_eu
    ...
    show char_lyra_sadness_eu
    GG_name "Да."
    GG_name "{i}За столько лет так и не приблизилась к разгадке смерти моей матери.{/i}" 
    GG_name "{i}Сигрид не хочет ни подтвердить, ни опровергнуть предательство.{/i}"
    hide char_lyra_sadness_eu
    ...
    show char_sigrid_smile 
    Sigrid "Я верю в тебя."
    Sigrid "Ты была достойной ученицей. Пришло время превзойти учителя."
    hide char_sigrid_smile 
...
label scene9_sigrid_fav:
    ...
    GG_name "{i}Могу ли я попросить обнять меня?{/i}"
    hide char_lyra_neutral_eu
    ...
    show char_sigrid_thoughtful
    Sigrid "Дай мне подумать."
    Sigrid "Ингрид… Пожалуй не знала, что такое поддержка."
    hide char_sigrid_thoughtful
    ...
    "[main_charecter_name] жадно впитывала это тепло кожей. Прежде, чем объятия стали неприлично долгими, [main_charecter_name] разжала руки и посмотрела в глаза Сигрид. В памяти отпечатался запах сена и раскаленного железа."
    nvl clear
    
    show char_lyra_thougtful_eu
    GG_name "Так ли пахли и волосы моей матери?"
    hide char_lyra_thougtful_eu

    show char_lyra_smile_eu
    GG_name "Может быть. Потому что этот запах успокаивает."
...
label scene_10:
    ...
    "{i}[main_charecter_name] прикрыла глаза, медленно вдыхая и выдыхая. Предстоит что-то тяжелое.{/i}"
    nvl clear 
...
label scene10_armor: 
    ...
    show char_sigrid_smile
    Sigrid "Назначение твоей матери не было таким внезапным, как твоё."
    hide char_sigrid_smile
...
label scene_11:
    ...
    Agness "Леди [main_charecter_name]! Я... Я буду вашей оруженосицей, меня зовут Агнесса!"
...
label scene_12:
    ...
    show char_agnessa_neutral
    Agness "Может, нам взять еще провизии? Не только ту, что лежит в сумках на лошадях."
    hide char_agnessa_neutral

    show char_veila_sarcasm
    Veila "Вдруг принцессе захочется пикника?" 
    Veila "Это не прогулка, девочка. Лошади тоже устают, им незачем лишний груз."
    hide char_veila_sarcasm
...
label scene_13:
    ...
    show char_lyra_sadness_eu
    GG_name "Что если я провалю миссию?"
    hide char_lyra_sadness_eu
...
label scene_14:
    ...
    nvl clear
    GG_name "Видно, ехать придется дня полтора."
    hide char_lyra_neutral_eu
